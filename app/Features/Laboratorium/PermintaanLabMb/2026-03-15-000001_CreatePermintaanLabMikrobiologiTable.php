...
final class CreatePermintaanLabMikrobiologiTable extends DatabaseTemplate
{
    ...
    parent::__construct(
        ...
        [
            ...
            ['id_parameter_pemeriksaan', 'laboratorium.ref_parameter_pemeriksaan_lab', 'id_parameter'],
        ],
    );
}
}
