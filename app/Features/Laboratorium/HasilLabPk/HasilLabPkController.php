...
final class HasilLabPkController extends ControllerTemplate
{
    public function __construct()
    {
        parent::__construct(
            ...
            konfig: [
                [HIDE, 'ID Hasil PK',              'id_hasil_pk',              'indeks',  OPTIONAL],
                ...
                [SHOW, 'ID Kategori Usia',         'id_kategori_usia',         'indeks',  REQUIRED],
                ...
                [SHOW, 'Keterangan Hasil',         'keterangan_hasil',         'teks',    OPTIONAL],
            ],
        );
    }
}