...
final class CreatePengambilanDarahTable extends DatabaseTemplate
{
    public function __construct(){
        parent::__construct(
            ...
            [
                ...
                ['id_jenis_donor', 'jenis_donor', 'id_jenis_donor'],
                ['id_lokasi_pengambilan', 'lokasi_pengambilan_darah', 'id_lokasi_pengambilan'],
