    ...
    public function __construct()
    {
        parent::__construct(
            ...
            [
                ...
                'pengajuan_pembatalan'        => T::BOOL()->nullable(),
                'alasan_pembatalan'           => T::NOTE()->nullable(),
                'petugas_gudang_pembatalan'   => T::FK_AUTO()->nullable(),
                'tanggal_pembatalan'          => T::DTIME()->nullable(),
            ],
            'id_permintaan',
            [],
            [
