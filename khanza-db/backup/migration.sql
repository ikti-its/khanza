...
CREATE TABLE public.alasan_cuti_structure (
    id character varying(2) NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.departemen_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.golongan_barang_medis_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.hari_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.industri_farmasi_structure (
    id integer NOT NULL,
    kode character varying(20) NOT NULL,
    nama character varying(50) NOT NULL,
    alamat character varying(255) NOT NULL,
...
CREATE TABLE public.jabatan_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.jenis_barang_medis_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.kategori_barang_medis_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.organisasi_structure (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    nama character varying(255) NOT NULL,
    alamat character varying(255) NOT NULL,
    latitude numeric NOT NULL,
...
CREATE TABLE public.role_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.ruangan_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.satuan_barang_medis_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.shift_structure (
    id character varying(2) NOT NULL,
    nama character varying(50) NOT NULL,
    jam_masuk time with time zone NOT NULL,
    jam_pulang time with time zone NOT NULL,
...
CREATE TABLE public.status_aktif_pegawai_structure (
    id character varying(2) NOT NULL,
    nama character varying(50) NOT NULL,
    created_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP
...
CREATE TABLE public.supplier_barang_medis_structure (
    id integer NOT NULL,
    nama character varying(50) NOT NULL,
    alamat character varying(255) NOT NULL,
    no_telp character varying(20) NOT NULL,
